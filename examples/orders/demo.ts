...
console.log('  as user:north-sales:', rt.search('Order', { actor: 'user:north-sales' }).objects.map((o) => o.pk))
console.log('  as user:hq:         ', rt.search('Order', hq).objects.map((o) => o.pk))
...
console.log('notes on N-A-1002:    ', rt.traverse(reindexed, 'orderNotes', hq).objects.map((n) => n.properties.text))
