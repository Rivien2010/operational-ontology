...
import type {
  ...
  ObjectOf, ObjectTypeDef, OntologyDef, Properties, TraverseOptions, Violation, FunctionResultOf,
} from './model.js'
...
export class Runtime<Model extends OntologyDef = OntologyDef> {
  ...
  // These checks see the whole stored graph, including hidden endpoints.
