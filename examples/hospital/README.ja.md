...
<img src="./assets/ontology-overview.png" alt="病院のオントロジー全体図。Hospital から Patient・Bed・Nurse、Patient から Admission へリンクする。bedSearch・nurseSearch が候補を評価し、allocate が選択内容を再検査して ontology-owned な Allocation と患者・病床・看護師へのリンクを作る。">
